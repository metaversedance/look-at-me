...
/***/ function(module, exports) {
	...
	delete AFRAME.components['look-at-local-space'];
	 ...
	 */
	AFRAME.registerComponent('look-at-local-space', {
	  schema: {
	    default: '',
	  ...
	  tick: function (t) {
	    ...
	    if (target3D) {
	    	var worldVec = this.vector.setFromMatrixPosition(target3D.matrixWorld)
	    	var localVec = this.el.object3D.worldToLocal(worldVec)
	      return this.el.object3D.lookAt(localVec);
	    }
	  },
